...
def main():
    ...
    with open(train_split_path, 'r') as f:
        train_files = {line.strip()[:-2]: 'train' for line in f.readlines()}
    with open(val_split_path, 'r') as f:
        val_files = {line.strip()[:-2]: 'val' for line in f.readlines()}
    with open(test_split_path, 'r') as f:
        test_files = {line.strip()[:-2]: 'test' for line in f.readlines()}
    ...
    for data_split in ['train.txt', 'val.txt', 'test.txt']:
    ...
    for seq in sequences:
        ...
        for i in tqdm(range(len(pose))):
            ...
            fds[all_files[f'{int(seq)} {i}']].write(f'{relative_save_path},{sum_euler}\n')
